...
func test_tab_and_slot_hit_tests() -> void:
	assert_int(DebugPanel.tab_at(Vector2(181, 21))).is_equal(0)
	assert_int(DebugPanel.tab_at(Vector2(296, 25))).is_equal(5)
	assert_int(DebugPanel.tab_at(Vector2(100, 25))).is_equal(-1)
	assert_int(DebugPanel.slot_at(Vector2(190, 37))).is_equal(0)
	assert_int(DebugPanel.slot_at(Vector2(190, 37 + 8 * 14))).is_equal(8)
	assert_int(DebugPanel.slot_at(Vector2(190, 49))).is_equal(-1)
	assert_int(DebugPanel.slot_at(Vector2(190, 37 + 9 * 14))).is_equal(-1)
...
func test_panel_and_tabs_fit() -> void:
	...
	assert_float(panel.end.x).is_equal(320.0)
