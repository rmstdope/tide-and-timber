...
const ZIP := "res://assets/vendor/elv_games/Retro Inventory.zip"
const ZIP_SHA256 := "3b3460c4665cb2d03e956e7fcb475ff30aaffd257b74e22ffeba801689c6a3be"
const ZIP_ROOT := "Retro Inventory/Original/"
const UNPACKED := "res://assets/retro_inventory/"
const LEDGER := "res://assets/VENDORED.md"
const PNG_COUNT := 82
const LEDGER_ROW := "| Retro Inventory | undated | assets/vendor/elv_games/Retro Inventory.zip, bought from ElvGames (https://twitter.com/ElvGames) | 3b3460c4665cb2d03e956e7fcb475ff30aaffd257b74e22ffeba801689c6a3be | ElvGames' terms: commercial use and alteration allowed, **credit to ElvGames required**, not to be sold as assets (assets/vendor/elv_games/LICENSE) |"
...
func test_ledger_lists_the_retro_inventory_pack() -> void:
